      ...
      <section className="portfolio-content" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 180px)', paddingBottom: '40px', scrollbarWidth: 'none' }}>
        ...
        <div className="case-header" style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--light-gray-70)', lineHeight: '1.6', fontSize: '15px' }}>
            ...
            combinando Inteligência Artificial, integrações complexas com WhatsApp e arquitetura de microsserviços.
          </p>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
            {[
              ...
              { title: 'Infraestrutura Resiliente & Docker', desc: 'Para manter a API do WhatsApp estável, desenvolvemos microsserviços em Node.js isolados em containers Docker na Oracle Cloud, garantindo alta disponibilidade e comunicação segura.' },
